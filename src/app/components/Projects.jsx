...
const Projects = () => {
  return (
    <div className="text-center p-10 md:flex md:justify-between md:items-center">
      ...
      <div>
        <h3 className="text-lg font-bold text-left py-5 text-teal-600">
        ...
        <p className="text-sm text-left py-5 text-gray-800">
          ...
          can browse articles, sort articles by votes, comments, and dates, post
          new comments, and vote on articles and comments. You can also create
          new articles and topics.
        </p>
        <div className="flex">
          <Link
      ...
      <div>
        ...
        <Image src={PlaidPal} width={400} height={400} className="rounded-lg" />
        <ul className="text-left">
          <li className="inline-block bg-gray-200 text-gray-800 px-1 py-0.5 rounded text-xs mr-2">
            Javascript
          </li>
        ...
        <p className="text-sm text-left py-5 text-gray-800">
          ...
          place, and get a comprehensive view of your financial transactions and
          balances. PlaidPal uses the MERN stack which consists of four main
          technologies: MongoDB, Express, React, and Node.js. Each of these
          technologies plays an important role in PlaidPal and works together to
          create a seamless and powerful user experience.
        </p>
        <div className="flex">
          <Link
            href="https://insightcorner.netlify.app/"
      ...
      <div>
        ...
        <p className="text-sm text-left py-5 text-gray-800">
          ...
          each exercise to monitor their progress. The app aims to be a resource
          for people looking to improve their physical fitness by providing
          exercise guides and information. The app also includes a records page
          where users can log their weights and repetitions for each exercise,
          along with a date stamp, to see their progress in each muscle group.
        </p>
        <div className="flex">
          <Link
